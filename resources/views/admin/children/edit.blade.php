...
<head>
    ...
    <title>Редактировать ребенка - 7 Звезд</title>
    ...
    <main class="flex-grow">
        <div class="bg-gradient-to-r from-purple-100 to-white py-12">
            <div class="container mx-auto px-4 text-center">
                <h1 class="text-3xl font-bold gradient-text mb-2">Редактировать ребенка</h1>
                <p class="text-lg text-gray-700">Обновление информации о ребенке</p>
            </div>
        </div>
                        ...
                        <form action="{{ route('children.update', $child) }}" method="POST" class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="last_name" id="last_name" 
                                           ...
                                           value="{{ old('last_name', $child->last_name) }}" required maxlength="50">
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="first_name" id="first_name" 
                                           class="form-input w-full px-4 py-2 border border-gray-300 rounded-lg" 
                                           value="{{ old('first_name', $child->first_name) }}" required maxlength="50">
                                </div>
                                <div>
                                    ...
                                    <input type="text" name="patronymic" id="patronymic" 
                                           class="form-input w-full px-4 py-2 border border-gray-300 rounded-lg" 
                                           value="{{ old('patronymic', $child->patronymic) }}" maxlength="50">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="date" name="birth_date" id="birth_date" 
                                       class="form-input w-full px-4 py-2 border border-gray-300 rounded-lg" 
                                       value="{{ old('birth_date', $child->birth_date) }}" required>
