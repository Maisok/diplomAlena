...
<head>
    ...
    <title>Добавить пользователя - 7 Звезд</title>
    ...
    <main class="flex-grow">
        ...
        <div class="bg-gradient-to-r from-purple-100 to-white py-12">
            <div class="container mx-auto px-4 text-center">
                <h1 class="text-3xl font-bold gradient-text mb-2">Добавить пользователя</h1>
                <p class="text-lg text-gray-700">Создание новой учетной записи</p>
            </div>
        </div>
                ...
                <div class="p-8">
                    ...
                    <form action="{{ route('users.store') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="patronymic" id="patronymic" maxlength="50" 
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#4A3F9B] focus:border-[#4A3F9B] transition">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="phone_number" id="phone_number" 
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#4A3F9B] focus:border-[#4A3F9B] transition"
                                   placeholder="8 888 888 88 88" required>
                        </div>
