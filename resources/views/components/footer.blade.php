...
<footer class="bg-gray-900 text-white py-12">
    <div class="container mx-auto px-4">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          ...
          <p class="text-gray-400">
            Частный детский сад с 13-летним опытом работы. Гармоничное развитие детей от 1.5 до 7 лет.
          </p>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-2">
            ...
            <li><a href="#" class="text-gray-400 hover:text-white transition">Программы</a></li>
            <li><a href="#" class="text-gray-400 hover:text-white transition">Галерея</a></li>
        ...
        <div>
          ...
          <div class="flex space-x-4">
            <a href="#" class="bg-gray-800 w-10 h-10 rounded-full flex items-center justify-center hover:bg-purple-600 transition">
      ...
      <div class="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400 text-sm">
        <p>© 2024 Детский сад "7 звёзд". Все права защищены.</p>
      </div>
    </div>
  </footer>