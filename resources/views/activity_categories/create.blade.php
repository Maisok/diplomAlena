...
<head>
    ...
    <title>Добавить категорию - 7 Звезд</title>
    ...
    <main class="flex-grow">
        ...
        <div class="bg-gradient-to-r from-purple-100 to-white py-12">
            <div class="container mx-auto px-4 text-center">
                <h1 class="text-3xl font-bold gradient-text mb-2">Добавить категорию</h1>
                <p class="text-lg text-gray-700">Создание новой категории деятельности</p>
            </div>
        </div>
        ...
        <div class="container mx-auto px-4 py-12">
            <div class="max-w-2xl mx-auto">
                ...
                <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                    <div class="p-6">
                        <form action="{{ route('activity-categories.store') }}" method="POST" class="space-y-6">
                            @csrf
